...
import 'package:space_station/src/dev_mode.dart';
...
void main() {
  ...
  test('JIT (a VM service) arms the seat: the reload tool is composed, the '
      'handshake ADVERTISES it, and dispatching it re-composes the tree', () async {
    final builds = <int>[];
    final grid = runGrid(
    ...
    final restart = await seat.host.dispatchTool('reload', {'mode': 'restart'});
